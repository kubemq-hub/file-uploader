...
func getZapConfigWithLevel(level string) zap.Config {
...
func NewLogger(name string) *Logger {
	zapLogger, _ := getZapConfig().Build()
	l := &Logger{
...
func NewLoggerWithLevel(name, level string) *Logger {
	zapLogger, _ := getZapConfigWithLevel(level).Build()
	l := &Logger{
		SugaredLogger: zapLogger.Sugar().With("source", name),
	}
